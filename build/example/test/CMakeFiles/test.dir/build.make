...
bin/test-11d9063: example/test/CMakeFiles/test.dir/example.cpp.o
bin/test-11d9063: example/test/CMakeFiles/test.dir/build.make
bin/test-11d9063: bin/libSeetaFaceDetector.so.11d9063
bin/test-11d9063: bin/libSeetaFaceLandmarker.so.11d9063
bin/test-11d9063: bin/libSeetaFaceRecognizer.so.11d9063
bin/test-11d9063: bin/libSeetaQualityAssessor.so.11d9063
bin/test-11d9063: /usr/local/lib/libopencv_dnn.so.4.3.0
bin/test-11d9063: /usr/local/lib/libopencv_gapi.so.4.3.0
bin/test-11d9063: /usr/local/lib/libopencv_highgui.so.4.3.0
bin/test-11d9063: /usr/local/lib/libopencv_ml.so.4.3.0
bin/test-11d9063: /usr/local/lib/libopencv_objdetect.so.4.3.0
bin/test-11d9063: /usr/local/lib/libopencv_photo.so.4.3.0
bin/test-11d9063: /usr/local/lib/libopencv_stitching.so.4.3.0
bin/test-11d9063: /usr/local/lib/libopencv_video.so.4.3.0
bin/test-11d9063: /usr/local/lib/libopencv_videoio.so.4.3.0
bin/test-11d9063: bin/libSeetaNet.so.11d9063
bin/test-11d9063: /usr/local/lib/libopencv_imgcodecs.so.4.3.0
bin/test-11d9063: /usr/local/lib/libopencv_calib3d.so.4.3.0
bin/test-11d9063: /usr/local/lib/libopencv_features2d.so.4.3.0
bin/test-11d9063: /usr/local/lib/libopencv_flann.so.4.3.0
bin/test-11d9063: /usr/local/lib/libopencv_imgproc.so.4.3.0
bin/test-11d9063: /usr/local/lib/libopencv_core.so.4.3.0
bin/test-11d9063: example/test/CMakeFiles/test.dir/link.txt
	...
	cd /home/hustccc/SeetaFace2/build/example/test && $(CMAKE_COMMAND) -E cmake_symlink_executable ../../bin/test-11d9063 ../../bin/test

bin/test: bin/test-11d9063
