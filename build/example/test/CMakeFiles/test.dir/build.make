...
bin/test-a6e9ef3: example/test/CMakeFiles/test.dir/example.cpp.o
bin/test-a6e9ef3: example/test/CMakeFiles/test.dir/build.make
bin/test-a6e9ef3: bin/libSeetaFaceDetector.so.a6e9ef3
bin/test-a6e9ef3: bin/libSeetaFaceLandmarker.so.a6e9ef3
bin/test-a6e9ef3: bin/libSeetaFaceRecognizer.so.a6e9ef3
bin/test-a6e9ef3: bin/libSeetaQualityAssessor.so.a6e9ef3
bin/test-a6e9ef3: /usr/local/lib/libopencv_dnn.so.4.3.0
bin/test-a6e9ef3: /usr/local/lib/libopencv_gapi.so.4.3.0
bin/test-a6e9ef3: /usr/local/lib/libopencv_highgui.so.4.3.0
bin/test-a6e9ef3: /usr/local/lib/libopencv_ml.so.4.3.0
bin/test-a6e9ef3: /usr/local/lib/libopencv_objdetect.so.4.3.0
bin/test-a6e9ef3: /usr/local/lib/libopencv_photo.so.4.3.0
bin/test-a6e9ef3: /usr/local/lib/libopencv_stitching.so.4.3.0
bin/test-a6e9ef3: /usr/local/lib/libopencv_video.so.4.3.0
bin/test-a6e9ef3: /usr/local/lib/libopencv_videoio.so.4.3.0
bin/test-a6e9ef3: bin/libSeetaNet.so.a6e9ef3
bin/test-a6e9ef3: /usr/local/lib/libopencv_imgcodecs.so.4.3.0
bin/test-a6e9ef3: /usr/local/lib/libopencv_calib3d.so.4.3.0
bin/test-a6e9ef3: /usr/local/lib/libopencv_features2d.so.4.3.0
bin/test-a6e9ef3: /usr/local/lib/libopencv_flann.so.4.3.0
bin/test-a6e9ef3: /usr/local/lib/libopencv_imgproc.so.4.3.0
bin/test-a6e9ef3: /usr/local/lib/libopencv_core.so.4.3.0
bin/test-a6e9ef3: example/test/CMakeFiles/test.dir/link.txt
	...
	cd /home/hustccc/SeetaFace2/build/example/test && $(CMAKE_COMMAND) -E cmake_symlink_executable ../../bin/test-a6e9ef3 ../../bin/test

bin/test: bin/test-a6e9ef3
