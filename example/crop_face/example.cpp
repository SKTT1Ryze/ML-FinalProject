...
int main(int argc, char*argv[])
{
    ...
    std::string PicturesStorePath = "/home/hustccc/Pictures/FaceRecognize/";
    std::string test_image = PicturesStorePath+argv[1]+".jpg";
    std::string crop_image_name = PicturesStorePath+argv[1]+"_crop.jpg";
